                    ...
                    */
                    ...
                    else
                    {
                           ...
                           sOut = oSettings.oLanguage.sInfo.
                                  ...
                                  oSettings.oLanguage.sInfoPostFix;
                                  $('div.search-result-header').show().find('p').html('');
                    }
                    ...
                    for ( var i=0, iLen=n.length ; i<iLen ; i++ )
                    {
                           $(n[i]).html( sOut );
                           //alert(sTotal)
                    $('div.search-result-header').find('div').html('');
                    $('div.search-result-header').find('p').html("Busca Aplicada: "+sTotal+" resultados encontrados. <a href='javascript:;' onclick='clearFilters()'>Desfazer</a>");
                    $('div.search-result-header').append('<div class="result-count-hist99">Mostrar por vez: <span>10</span> | <a href="#">20</a> |<a href="#">40</a></div>');
                           //$('div.search-result-header p').show('slow').html("Busca Aplicada: "+sTotal+" resultados encontrados. <a href='#'>Desfazer</a>");
                    }
             }
