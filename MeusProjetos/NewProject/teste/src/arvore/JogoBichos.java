...
public class JogoBichos {
    ...
    public static void main(String[] args) {
        ...
        jogar = JOptionPane.showConfirmDialog(null, "Esse é o jogo dos bichos, vamos jogar?", "Jogo dos bichos", JOptionPane.YES_NO_OPTION);
        while (jogar == JOptionPane.YES_OPTION) {
            ...
            while (!fimDeJogo) {
                resposta = JOptionPane.showConfirmDialog(null, String.format("O bicho %s?", bichoAtual.getDescricao()), "", JOptionPane.YES_NO_OPTION);

                
                if (resposta == JOptionPane.YES_OPTION) {
                    resposta = JOptionPane.showConfirmDialog(null, String.format("O bicho é o(a) %s?", bichoAtual.getNome()), "", JOptionPane.YES_NO_OPTION);
            ...
            jogar = JOptionPane.showConfirmDialog(null, "Vamos jogar novamente?", "Jogo dos bichos", JOptionPane.YES_NO_OPTION);
        }
    ...
    private static NoBicho caminhaArvore(NoBicho bicho, NoBicho.DIRECAO dir) {
        ...
        if (prox != null) {
            ...
            while (nomeBicho == null || nomeBicho.equals("")) {
                nomeBicho = JOptionPane.showInputDialog(null, "Qual o nome do bicho que você pensou?", "Desisto!!!", JOptionPane.QUESTION_MESSAGE);
            }
            descricaoBicho = null;
